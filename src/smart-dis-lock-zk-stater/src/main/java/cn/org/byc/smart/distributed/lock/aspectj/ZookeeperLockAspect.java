package cn.org.byc.smart.distributed.lock.aspectj;

import cn.hutool.core.util.ArrayUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import cn.org.byc.smart.distributed.lock.annotation.LockKeyParam;
import cn.org.byc.smart.distributed.lock.annotation.ZookeeperLock;
...
public class ZookeeperLockAspect {
     ...
     * 切入点
     */
    @Pointcut("@annotation(cn.org.byc.smart.distributed.lock.annotation.ZookeeperLock)")
    public void doLock() {
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        ZookeeperLock zkLock = method.getAnnotation(ZookeeperLock.class);
     ...
     */
    private String buildLockKey(ZookeeperLock lock, Method method, Object[] args) throws NoSuchFieldException, IllegalAccessException {
